...
```groovy
implementation 'com.microsoft.design:fluent-system-icons:1.1.97'
```
...
pod "FluentIcons", "1.1.97"
```

#### Carthage

```bash
git "git@github.com:microsoft/fluentui-system-icons.git" "1.1.97"
```
